...
<head>
    ...
    <!--================= Magnific Popup CSS =================-->
    <link rel="stylesheet" href="{{asset('css/fontawesome-5.css')}}">
    <!--================= Base CSS =================-->
    ...
    <div class="main-header__layout">
        <div class="main-header__inner">
            <div class="main-header__logo">
                <div class="logo-dark">
                    <a href="index.html">
                        <img src="{{asset('img/logo-dark.svg')}}" alt="Most">
                    </a>
                </div>
    ...
    <div class="banner-horizental">
        <div class="swiper swiper-container-h">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="slider-inner" data-swiper-parallax="100">
                        <img src="{{asset('img/most_slide_1.jpg')}}" alt="full_screen-image">
                        <div class="swiper-content" data-swiper-parallax="2000">
                            ...
                            <div class="btn-wrap">
                                <a class="btn btn-circle btn--md" role="button" href="#0">
                ...
                <div class="swiper-slide">
                    <div class="slider-inner" data-swiper-parallax="100">
                        <img src="{{asset('img/most_slide_2.jpg')}}" alt="full_screen-image">
                        <div class="swiper-content" data-swiper-parallax="2000">
                            <div class="title-area">
                                <!-- title-area -->
                                <p class="tag">INSPIRATION</p>
                                <a href="#" class="title"> MOTION </a>
                                <!-- title area -->
                            </div>
                            <p class="disc">
            ...
            <div class="slider-pagination-area">
                ...
                <div class="swiper-pagination swiper-pagination-progressbar swiper-pagination-horizontal"><span class="swiper-pagination-progressbar-fill" style="transform: translate3d(0px, 0px, 0px) scaleX(0.666667) scaleY(1); transition-duration: 1500ms;"></span></div>
...
<!--================= Video JS =================-->
<script src="{{asset('js/video-background.js')}}"></script>
<!--================= Main JS =================-->
